...
exports.parseMailHeaders = parseMailHeaders;
function splitDoc(s) {
    var bodyStart = s.search(regexes.doubleNewLine);
    if (bodyStart < 0) {
        let end = s.lastIndexOf("\r\n");
...
//根据boundary分割
function split_boundary(s, boundaries, stepFirst = true) {
...
//替换子项中产生的boundary
function clean_sub_boundary(body, root_boundary) {
    do {
